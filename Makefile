...
test-full: test
	...
	erl -pa $(EBIN_DIR) -eval 'concurrent_env_management_test:run_all_tests(), halt().' -noshell
	erl -pa $(EBIN_DIR) -eval 'concurrent_txn_management_test:run_all_tests(), halt().' -noshell
